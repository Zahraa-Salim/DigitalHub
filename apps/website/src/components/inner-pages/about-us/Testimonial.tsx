// File: src/components/inner-pages/about-us/Testimonial.tsx
// Purpose: UI component responsible for rendering part of the interface (inner-pages/about-us/Testimonial.tsx).
