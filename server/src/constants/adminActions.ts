...
export const ADMIN_ACTIONS = {
  ...
  STUDENT_PROFILE_AVATAR_UPLOADED: "STUDENT_PROFILE_AVATAR_UPLOADED",
  STUDENT_ENROLLMENT_ADDED: "STUDENT_ENROLLMENT_ADDED",
  STUDENT_ENROLLMENT_REMOVED: "STUDENT_ENROLLMENT_REMOVED",
} as const;
