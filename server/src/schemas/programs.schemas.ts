// File: server/src/schemas/programs.schemas.ts
// Purpose: Defines the Zod schemas for programs.
...
export const programCreateSchema = z
    ...
    description: z.string().trim().max(50000, "Description is too long.").optional(),
