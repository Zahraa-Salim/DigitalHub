...
export const IMPORTABLE_TABLES: ImportableTable[] = [
  {
    key: "students",
    label: "Students (Create or Update)",
    ...
    columns: [
      {
        ...
        required: true,
        type: "text",
        hint: "Primary identifier — creates a new student if this email doesn't exist yet, updates if it does",
      },
      {
        key: "full_name",
        label: "Full Name",
      ...
      },
      {
        ...
        required: false,
        type: "text",
        hint: "Only used when creating a new student account",
      },
      {
        key: "cohort_id",
        label: "Cohort ID",
        required: false,
        type: "number",
        hint: "Numeric cohort ID — export Cohorts to find IDs. Student is enrolled on create/update.",
      },
      {
        key: "cv_url",
        label: "CV URL",
        required: false,
        type: "text",
        hint: "Google Drive, Dropbox, OneDrive, or direct link",
      },
      {
        key: "bio",
        label: "Bio",
      ...
      },
      {
        ...
        required: false,
        type: "boolean",
        hint: "true or false — defaults to false",
      },
      {
        key: "is_graduated",
        label: "Graduated",
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "public_slug", label: "Public Slug", required: false, type: "text", hint: "URL-friendly identifier" },
      { key: "is_public", label: "Is Public", required: false, type: "boolean" },
      { key: "featured", label: "Featured", required: false, type: "boolean" },
      { key: "featured_rank", label: "Featured Rank", required: false, type: "number" },
      { key: "is_graduated", label: "Is Graduated", required: false, type: "boolean" },
