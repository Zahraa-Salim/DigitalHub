// File: frontend/src/dashboard/components/Sidebar.tsx
// Purpose: Renders the dashboard sidebar component.
...
export function Sidebar({ user, collapsed, onToggleSidebar, onNavigate, onLogout }: SidebarProps) {
  ...
  const roleLabel = user.admin_role === "super_admin" ? "super admin" : "admin";
  const profileBadgeLabel = roleLabel;
