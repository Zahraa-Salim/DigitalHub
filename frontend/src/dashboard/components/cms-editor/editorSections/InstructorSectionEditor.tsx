...
type InstructorSectionEditorProps = {
...
const InstructorSectionEditor = ({ content, sectionId }: InstructorSectionEditorProps) => {
  ...
  const ctaLink = getValue(sectionId, "cta_link") || getCmsString(content, ["cta_link", "button_link"], "/team");
            ...
            <div className="col-xl-4">
              <div className="instructor__content-wrap">
                <div className="section__title mb-15">
                  <EditableSpan sectionId={sectionId} field="subtitle" fallback="Meet The Digital Hub Team" tag="span" className="sub-title" />
                  <EditableSpan
                    sectionId={sectionId}
                    field="title"
                    fallback="Our Core Team of Managers and Instructors"
                    tag="h2"
                    className="title"
                  />
                </div>
                <p>
                  <EditableSpan
                    sectionId={sectionId}
                    field="description"
                    fallback="Meet the people behind Digital Hub programs, mentorship, and delivery. Our team supports learners from training to career readiness."
                    multiline
                  />
                </p>
                <div className="tg-button-wrap">
                  <Link to={ctaLink} className="btn arrow-btn">
                    <EditableSpan sectionId={sectionId} field="cta_text" fallback="Meet The Full Team" />
                    <BtnArrow />
                  </Link>
                </div>
              </div>
...
export default InstructorSectionEditor;
