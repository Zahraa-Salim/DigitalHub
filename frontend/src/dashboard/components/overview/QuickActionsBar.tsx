// File: frontend/src/dashboard/components/overview/QuickActionsBar.tsx
// Purpose: Renders the overview quick actions bar panel in the dashboard.
  ...
  return (
    <div className="table-actions overview-quick-actions">
      ...
      <button
        className="btn btn--secondary btn--sm overview-quick-actions__primary"
        type="button"
        onClick={() => toAdmissions({ stage: "invited_to_interview", focus: "reschedule_requests" })}
      >
        Reschedule Requests
      </button>
      <button
