// File: frontend/src/dashboard/components/overview-mock/ActivityFeedPanel.tsx
// Purpose: Renders the mock overview activity feed panel panel for the dashboard.
