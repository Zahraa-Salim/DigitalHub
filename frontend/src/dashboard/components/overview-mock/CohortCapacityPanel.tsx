// File: frontend/src/dashboard/components/overview-mock/CohortCapacityPanel.tsx
// Purpose: Renders the mock overview cohort capacity panel panel for the dashboard.
