// File: frontend/src/dashboard/pages/admin/CmsPagesPage.tsx
// Purpose: Renders the admin CMS pages page page in the dashboard.
...
const PAGE_CONFIG: Record<PageKind, PageConfig> = {
  ...
  about: {
    fields: [
      ...
      {
        path: "banner_subtitle",
        label: "Page Banner Sub-label",
        type: "text",
        placeholder: "About Us",
        aliases: ["bannerSubtitle"],
      },
  ...
  events: {
    fields: [
      ...
      { path: "announcements_show_section", label: "Show Announcements Section", type: "checkbox", aliases: ["announcementsShowSection"] },
      { path: "announcements_per_page", label: "Announcements Per Page", type: "number", aliases: ["announcementsPerPage"] },
      { path: "announcements_title", label: "Announcements Section Title", type: "text", aliases: ["announcementsTitle"] },
      { path: "announcements_subtitle", label: "Announcements Section Subtitle", type: "text", aliases: ["announcementsSubtitle"] },
      {
        path: "announcements_description",
        label: "Announcements Section Description",
        type: "textarea",
        aliases: ["announcementsDescription"],
      },
      { path: "announcements_empty_text", label: "Announcements Empty State Text", type: "text", aliases: ["announcementsEmptyText"] },
    ],
  },
  event_details: {
    fields: [
