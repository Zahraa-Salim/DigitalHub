    ...
    >
      <section className="students-layout">
        ...
        <SearchBar
          value={search}
          onChange={setSearch}
          placeholder="Search instructor name, expertise, or skills"
          ariaLabel="Search instructor name, expertise, or skills"
        />
          ...
          <>
            <Card className="card--table dh-table-wrap">
              <Table<InstructorRow>
                ...
                { key: "skills", label: "Skills", render: (r) => asText(r.skills) },
                {
                  key: "visibility",
                  label: "Visibility",
            ...
            <div className="profile-modal-sections">
              ...
              <section className="profile-modal-section">
                ...
                <div className="form-stack">
                  ...
                  <label className="field"><span className="field__label">Skills (comma-separated)</span><textarea className="textarea-control" value={createForm.skills} onChange={(e) => setCreateForm((c) => ({ ...c, skills: e.target.value }))} placeholder="React, Node.js, PostgreSQL" /></label>
            ...
            <div className="profile-modal-sections">
              ...
              <section className="profile-modal-section">
                ...
                <div className="form-stack">
                  ...
                  <label className="field"><span className="field__label">Skills (comma-separated)</span><textarea className="textarea-control" value={editForm.skills} onChange={(e) => setEditForm((c) => ({ ...c, skills: e.target.value }))} placeholder="React, Node.js, PostgreSQL" /></label>
