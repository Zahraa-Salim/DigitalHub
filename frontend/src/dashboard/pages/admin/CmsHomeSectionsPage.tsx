...
const SECTION_CONFIG: Record<SectionKind, SectionConfig> = {
  ...
  announcements: {
    note: "This controls the home announcement section heading and card count. The announcement cards come from Dashboard > Announcements.",
    fields: [
      { path: "subtitle", label: "Subtitle", type: "text", aliases: ["sub_title"], defaultValue: "Latest Updates" },
      { path: "title", label: "Title", type: "text", aliases: ["heading"], defaultValue: "What Is Happening At The Digital Hub" },
      {
        path: "description",
        label: "Description",
        type: "textarea",
      ...
      { path: "limit", label: "Cards Limit", type: "number", defaultValue: 6 },
      { path: "cta_text", label: "CTA Text", type: "text", aliases: ["button_text"], defaultValue: "View All Updates" },
      { path: "cta_link", label: "CTA Link", type: "text", aliases: ["button_link"], defaultValue: "/events" },
    ],
  },
  about: {
    fields: [
