...
import faq_img1 from "@/assets/img/others/h5_faq_img.jpg"
import faq_img3 from "@/assets/img/others/h5_faq_shape02.svg"
import faq_img4 from "@/assets/img/others/h5_faq_shape03.svg"
import faq_img5 from "@/assets/img/others/h5_faq_shape01.svg"
               ...
               <div className="col-lg-6 col-md-8 order-0 order-lg-2">
                  <div className="faq__img-three">
                     ...
                     <div className="shape shape-one" data-aos="fade-down-left" data-aos-delay="400">
                        <Image src={faq_img3} alt="shape" className="tg-motion-effects3" />
                     </div>
