...
import event_shape1 from "@/assets/img/events/h3_event_shape01.svg"
import event_shape2 from "@/assets/img/events/h3_event_shape02.svg"
   ...
   return (
      <section className="event__area-three section-py-120">
                  ...
                  {event_data.filter((items) => items.page === "home_3").slice(0, 1).map((item) => (
                     <div key={item.id} className="event__item-two shine__animate-item">
                        <div className="event__thumb-two">
                           <Link to="/events-details" className="shine__animate-link"><Image src={item.thumb} alt="img" /></Link>
         ...
         <div className="event__shape-wrap">
            <Image src={event_shape1} alt="shape" data-aos="fade-right" data-aos-delay="200" />
            <Image src={event_shape2} alt="shape" data-aos="fade-up-right" data-aos-delay="400" />
         </div>
      </section>
   )
}
