...
import testi_img1 from "@/assets/img/others/testimonial_img.jpg";
import testi_img2 from "@/assets/img/others/testimonial_img_shape.svg"
import testi_img3 from "@/assets/img/others/h4_testimonial_shape.svg"
   ...
   return (
      <section className="testimonial__area-three section-py-140 testimonial__bg-two" style={{ backgroundImage: `url(/assets/img/bg/h4_testimonial_bg.jpg)` }}>
            ...
            <div className="row align-items-center justify-content-center">
               <div className="col-lg-6 col-md-10">
                  <div className="testimonial__img">
                     ...
                     <div className="shape">
                        <Image src={testi_img2} alt="shape" className="rotateme" />
                     </div>
                  </div>
               </div>
         ...
         <div className="testimonial__shape">
            <Image src={testi_img3} alt="shape" className="rotateme" />
         </div>
      </section>
   )
}
