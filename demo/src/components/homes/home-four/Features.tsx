...
import feature_shape1 from "@/assets/img/others/h4_features_shape01.svg"
import feature_shape2 from "@/assets/img/others/h4_features_shape02.svg"
   ...
   return (
      <section className="features__area-five features__bg section-pt-120 section-pb-90" style={{ backgroundImage: `url(/assets/img/bg/features_bg.jpg)` }}>
                        ...
                        <div key={item.id} className="col-lg-4 col-md-6">
                           <div className="features__item-four">
                              <div className="features__icon-four">
                                 <Image src={item.icon ? item.icon : ""} alt="" className="injectable" />
                              </div>
         ...
         <div className="features__shape-wrap">
            <Image src={feature_shape1} alt="shape" data-aos="fade-right" data-aos-delay="200" />
            <Image src={feature_shape2} alt="shape" data-aos="fade-left" data-aos-delay="200" />
         </div>
      </section>
   )
}
