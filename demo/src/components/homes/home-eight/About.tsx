...
import about_img1 from "@/assets/img/others/h8_about_img01.jpg"
import about_img2 from "@/assets/img/others/h8_about_img02.jpg"
import about_img3 from "@/assets/img/others/h8_about_img_shape.svg"
import about_img4 from "@/assets/img/others/h8_about_shape01.svg"
import about_img5 from "@/assets/img/others/h8_about_shape02.svg"
   ...
   return (
      <section className="about-area-six about__bg" style={{ backgroundImage: `url(/assets/img/bg/h8_about_bg.jpg)` }}>
            ...
            <div className="row align-items-center justify-content-center">
               <div className="col-lg-6 col-md-10">
                  <div className="about__images-six">
                     ...
                     <div className="shape">
                        <Image src={about_img3} alt="shape" className="alltuchtopdown" />
                     </div>
                  </div>
               </div>
         ...
         <div className="about__shape-wrap">
            <Image src={about_img4} alt="shape" data-aos="fade-down-right" data-aos-delay="400" />
            <Image src={about_img5} alt="shape" data-aos="fade-up-left" data-aos-delay="400" />
         </div>
      </section>
   )
}
