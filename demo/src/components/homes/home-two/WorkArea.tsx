...
import work_img1 from "@/assets/img/others/about_img.png"
import work_img2 from "@/assets/img/others/about_shape.svg"
               ...
               <div className="row align-items-center justify-content-center">
                  <div className="col-lg-6 col-md-9">
                     <div className="about__images work__images">
                        <Image src={work_img1} alt="img" className="main-img" />
                        <Image src={work_img2} alt="img" className="shape alltuchtopdown" />
