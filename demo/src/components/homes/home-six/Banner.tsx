...
import banner_img1 from "@/assets/img/banner/h6_hero_img.jpg"
import banner_img2 from "@/assets/img/others/student_grp.png"
import banner_img3 from "@/assets/img/banner/h6_banner_img_shape01.svg"
import banner_img4 from "@/assets/img/banner/h6_banner_img_shape02.svg"
                  ...
                  <div className="col-lg-7 col-md-9 col-sm-10 order-0 order-lg-2">
                     <div className="banner__images-six">
                        ...
                        <div className="shape-wrap">
                           <Image src={banner_img3} alt="shape" />
                           <Image src={banner_img4} alt="shape" className="alltuchtopdown" />
                        </div>
                     </div>
                  </div>
