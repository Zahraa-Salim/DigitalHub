...
import shape_1 from "@/assets/img/others/h5_footer_shape01.svg"
import shape_2 from "@/assets/img/others/h5_footer_shape02.svg"
                  ...
                  <div className="col-xl-2 col-lg-4 col-md-6">
                     <div className="footer__widget">
                        <div className="logo mb-35">
                           <Link to=""><Image src={logo} alt="img" /></Link>
                        </div>
